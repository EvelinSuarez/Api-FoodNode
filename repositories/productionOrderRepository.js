...
// --- FUNCIÓN PRIVADA ACTUALIZADA: AHORA CALCULA BASADO EN PESO ---
const _calculateAndVerifySupplyNeedsByWeight = async (data, transaction = null) => {
    ...
    // --- LÓGICA CLAVE: FACTOR DE ESCALA ---
    // (Cuánto más grande es mi producción deseada respecto a la receta base)
    ...
    for (const specSupply of specSheet.specSheetSupplies) {
        ...
        // La cantidad necesaria es la de la receta multiplicada por el factor de escala
