...
const customersValidations = require('../middlewares/customersValidations');

router.get('/search', customersValidations.searchCustomersValidation, customersController.searchCustomers);
